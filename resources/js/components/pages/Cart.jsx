...
const Cart = () => {
    ...
    const processMonetbilPayment = async () => {
        ...
        try {
            // Préparer les données pour l'API Monetbil
            const paymentData = {
                user_id: user.id,
    ...
    const handlePaymentSuccess = () => {
        ...
        setSuccessMessage('Votre paiement a été traité avec succès !');
        ...
        <div className="min-vh-100 bg-light" style={{ paddingTop: '80px' }}>
                                            ...
                                            {cartItems.map((item) => (
                                                <tr key={`${item.type}-${item.id}`}>
                                                    <td>
                                                        <div className="d-flex align-items-center">
                                                            <img
                                                                src={item.cover || '/images/default-cover.jpg'}
                                                                alt={item.title}
                                    ...
                                    <div className="suggestions-list">
                                        {suggestedSounds.map((sound) => (
                                            <div key={sound.id} className="suggestion-item d-flex align-items-center mb-3 p-2 border rounded">
                                                <img
                                                    src={sound.cover || '/images/default-cover.jpg'}
                                                    alt={sound.title}
                                                    className="rounded me-3"
                                                    style={{ width: '50px', height: '50px', objectFit: 'cover' }}
                                                />
            ...
            >
                <Modal.Body className="text-center p-4">
                    ...
                    <h4 className="mb-3">Paiement réussi !</h4>
