...
const AddSound = () => {
    ...
    const licenseTypes = {
        royalty_free: {
            ...
            description:
                "Utilisation illimitée après achat unique, idéal pour la plupart des projets",
            icon: faShieldAlt,
            color: "success",
        },
        creative_commons: {
            ...
            description:
                "Licence ouverte avec conditions spécifiques (attribution, partage, etc.)",
            icon: faCopyright,
            color: "info",
        },
        exclusive: {
            ...
            description:
                "Droits exclusifs transférés à l'acheteur, une seule vente possible",
            icon: faShieldAlt,
            color: "warning",
        },
        custom: {
    ...
    const usageRightsOptions = [
        {
            ...
            description: "Utilisation en radio et télévision",
        },
        {
            value: "streaming",
        ...
        },
        {
            ...
            description: "Films, publicités, jeux vidéo",
        },
        {
            value: "live",
            label: "Performances live",
            description: "Concerts, événements en direct",
        },
        {
            value: "remix",
            label: "Remix/Sampling",
            description: "Modification et échantillonnage autorisés",
        },
        {
            value: "youtube",
            label: "Monétisation YouTube",
            description: "Utilisation dans du contenu monétisé",
        },
    ];
    ...
    const validateCurrentStep = () => {
        ...
        switch (currentStep) {
            ...
            case 3: // Droits d'auteur
                isValid = !!(
                    formData.copyright_owner.trim() && formData.composer.trim()
                );
                break;
        ...
        if (type === "audio") {
            ...
            if (!validTypes.includes(file.type)) {
                setErrors((prev) => ({
                    ...prev,
                    audio_file:
                        "Format audio non supporté. Utilisez MP3, WAV, M4A ou AAC.",
                }));
                return;
            }
    ...
    const validateForm = () => {
        ...
        if (!formData.is_free && (!formData.price || formData.price <= 0)) {
            newErrors.price =
                "Le prix doit être supérieur à 0 pour un son payant";
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formData.bpm && formData.bpm.trim())
                submitData.append("bpm", formData.bpm.trim());
            ...
            if (formData.credits && formData.credits.trim())
                submitData.append("credits", formData.credits.trim());

            // Informations de licence et droits d'auteur
            submitData.append("license_type", formData.license_type);
            submitData.append(
                "copyright_owner",
                formData.copyright_owner.trim()
            );
            submitData.append("composer", formData.composer.trim());
            if (formData.performer && formData.performer.trim())
                submitData.append("performer", formData.performer.trim());
            if (formData.producer && formData.producer.trim())
                submitData.append("producer", formData.producer.trim());
            ...
            if (
                ...
                formData.publishing_rights.trim()
            ) {
                submitData.append(
                    "publishing_rights",
                    formData.publishing_rights.trim()
            ...
            submitData.append(
                "commercial_use",
                formData.commercial_use ? "1" : "0"
            );
            submitData.append(
                "attribution_required",
                formData.attribution_required ? "1" : "0"
            );
            submitData.append(
                "modifications_allowed",
                formData.modifications_allowed ? "1" : "0"
            );
            submitData.append(
                "distribution_allowed",
                formData.distribution_allowed ? "1" : "0"
            );
            ...
            if (formData.rights_statement && formData.rights_statement.trim()) {
                submitData.append(
                    "rights_statement",
                    formData.rights_statement.trim()
                );
            }
            ...
            if (response.ok) {
                setSuccess(
                    "Son ajouté avec succès ! Il sera disponible après validation."
                );
                ...
                if (data.errors) {
                    ...
                    setErrors({
                        general:
                            data.message || "Erreur lors de l'ajout du son",
                    });
                }
            }
        } catch (error) {
        ...
        <Card className="border-0 shadow-sm">
            <Card.Body className="p-5 text-center">
                ...
                <p className="text-muted mb-4">
                    Commencez par uploader votre création. Formats supportés :
                    MP3, WAV, M4A, AAC (max 20MB)
                </p>
                ...
                {!formData.audio_file ? (
                    ...
                    >
                        ...
                        />
                        <h5 className="mb-2">
                            Cliquez ici ou glissez votre fichier audio
                        </h5>
    ...
    const renderBasicInfoStep = () => (
        <Card className="border-0 shadow-sm">
            <Card.Header className="bg-white border-bottom-0">
                ...
                <p className="text-muted mb-0">
                    Décrivez votre son pour attirer vos auditeurs
                </p>
            </Card.Header>
            <Card.Body>
                <Row className="g-4">
    ...
    const renderCopyrightStep = () => (
        <Card className="border-0 shadow-sm">
            <Card.Header className="bg-white border-bottom-0">
                ...
                <p className="text-muted mb-0">
                    Informations légales importantes sur la propriété du son
                </p>
            </Card.Header>
            <Card.Body>
                <Alert variant="info" className="mb-4">
                    <FontAwesomeIcon icon={faInfoCircle} className="me-2" />
                    Ces informations sont essentielles pour protéger vos droits
                    et ceux des autres créateurs.
                </Alert>
                <Row className="g-4">
                    <Col md={6}>
                        <Form.Group>
        ...
        <div className="space-y-4">
            <Card className="border-0 shadow-sm mb-4">
                <Card.Header className="bg-white border-bottom-0">
                    ...
                    <p className="text-muted mb-0">
                        Définissez comment votre son peut être utilisé
                    </p>
                </Card.Header>
                <Card.Body>
                ...
                <Card.Body>
                            ...
                            <Col md={6}>
                                <Form.Group>
                                    ...
                                    <Form.Text className="text-muted">
                                        Prix suggérés : Instrumentaux 1500-5000
                                        FCFA, Complets 3000-10000 FCFA
                                    </Form.Text>
                                </Form.Group>
                            </Col>
                        )}
                            ...
                            <Col md={6} lg={4} key={option.value}>
                                <div className="border rounded p-3 h-100">
                                    <Form.Check
                                        ...
                                        checked={formData.usage_rights.includes(
                                            option.value
                                        )}
                                        onChange={(e) =>
                    ...
                    <Row className="g-3 mt-3">
                        <Col md={6}>
                            <Form.Group>
                                ...
                                <Form.Select
                                    ...
                                    size="lg"
                                >
                                    {Object.entries(licenseDurations).map(
                                        ([key, value]) => (
                        ...
                        <Col md={6}>
                            <Form.Group>
                                ...
                                <Form.Select
                                    ...
                                    size="lg"
                                >
                                    {Object.entries(territories).map(
                                        ([key, value]) => (
                                            <option key={key} value={key}>
                                                {value}
                                            </option>
                        ...
                        <Col>
                            <Form.Group>
                                <Form.Label className="fw-medium">
                                    Déclaration de droits (optionnel)
                                </Form.Label>
                                <Form.Control
                                    as="textarea"
                                    rows={3}
        ...
        <div className="space-y-4">
            <Card className="border-0 shadow-sm mb-4">
                <Card.Header className="bg-white border-bottom-0">
                    ...
                    <p className="text-muted mb-0">
                        Une belle image peut augmenter vos ventes de 70% !
                    </p>
                </Card.Header>
                <Card.Body>
                    ...
                    <Row className="g-3">
                        <Col md={6}>
                            <div className="border rounded p-3">
                                ...
                                {previews.audioDuration > 0 && (
                                    <small className="text-muted">
                                        Durée:{" "}
                                        {formatDuration(previews.audioDuration)}
                                    </small>
                                )}
                            </div>
                        </Col>
                        ...
                        <Col md={6}>
                            <div className="border rounded p-3">
                                ...
                                <p className="mb-1">
                                    {formData.copyright_owner || "Non défini"}
                                </p>
                                <small className="text-muted">
                                    Compositeur:{" "}
                                    {formData.composer || "Non défini"}
                                </small>
                            </div>
                        </Col>
                        <Col md={6}>
                            <div className="border rounded p-3">
                                ...
                                <p className="mb-1">
                                    {formData.is_free
                                        ? "💝 Gratuit"
                                        : `${formData.price || 0} FCFA`}
                                </p>
                                <small className="text-muted">
                                    Licence:{" "}
                                    {licenseTypes[formData.license_type]?.name}
                                </small>
                            </div>
                        </Col>
                    </Row>
